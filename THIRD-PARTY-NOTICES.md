...
### NSSM (the Non-Sucking Service Manager)  · Public Domain (CC0-like)
- 專案：https://nssm.cc/
- 用途：Windows 安裝時包成 Windows Service
- 作者：Iain Patterson；明確聲明為 public domain，無使用限制
- 自 v1.4.2 起，bundled 在 `packaging/windows/nssm.exe`（NSSM 2.24 win64 官方版，
  SHA-256 `f689ee9af94b00e9e3f0bb072b34caaf207f32dcb4f5782fc9ca351df9a06c97`），
  避免客戶踩到 nssm.cc 503 的下載失敗。`install.ps1` 在使用前會驗證 SHA-256，
  並提供網路下載 fallback。詳見 `packaging/windows/README.md`。
