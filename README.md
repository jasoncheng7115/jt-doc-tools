# Jason Tools 文件工具箱 v1.7.75

> 整合式 PDF / Office 文件處理平台，34 個工具一站式解決：**填單用印**、**浮水印**、**多頁合併 / 拆分 / 旋轉 / 整理**、**轉檔**、**去識別化**、**字數統計**、**註解整理**、**差異比對**、**逐句翻譯**、**清單處理**、**電子發票掃描**、**頁面編輯器**、**加密 / 解密**...
>
...
- **電子發票掃描** — 上傳台灣電子發票照片或 PDF，自動掃 QR Code 解出發票號碼 / 日期 / 金額 / 統編，準確率近 100%。手機掃完自動同步到電腦端列表（同帳號跨裝置共用）
