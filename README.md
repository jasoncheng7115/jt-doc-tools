...
[![Tests](https://img.shields.io/badge/pytest-376%20passed-brightgreen?logo=pytest)](tests/)
...
[![Platforms](https://img.shields.io/badge/platforms-Linux%20%7C%20macOS%20%7C%20Windows-lightgrey)](#安裝位置)
...
- [功能總覽](#功能總覽)
- [快速安裝（一行指令）](#快速安裝一行指令)
- [日常操作（`jtdt` 指令）](#日常操作jtdt-指令)
- [認證 / 角色 / 稽核合規](#認證--角色--稽核合規v1499-起)
  - [角色一覽](#角色一覽)
  - [內建帳號：`jtdt-admin` 與 `jtdt-auditor`](#內建帳號jtdt-admin-與-jtdt-auditor)
  - [第一次設定流程（建議）](#第一次設定流程建議)
  - [建立額外稽核員（多人合規團隊）](#建立額外稽核員多人合規團隊)
  - [一般 user / admin 自助啟用 2FA](#一般-user--admin-自助啟用-2fa)
  - [帳號鎖定 / 解鎖](#帳號鎖定--解鎖v150-加)
  - [admin 替 user 重設 2FA](#admin-替-user-重設-2fa)
- [緊急復原（鎖在外面、忘密碼、認證設錯）](#緊急復原鎖在外面忘密碼認證設錯)
- [安裝位置](#安裝位置)
- [反向代理（HTTPS）](#反向代理https)
- [系統需求](#系統需求)
- [隱私 / 安全](#隱私--安全)
- [開發 / 進階](#開發--進階)
- [授權](#授權)
