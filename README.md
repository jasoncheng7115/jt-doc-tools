...
```powershell
$u="https://raw.githubusercontent.com/jasoncheng7115/jt-doc-tools/main/install.ps1?cb=$(Get-Random)"; $f="$env:TEMP\jtdt-install.ps1"; [Net.ServicePointManager]::SecurityProtocol='Tls12'; $d=(New-Object Net.WebClient).DownloadData($u); [IO.File]::WriteAllText($f,[Text.Encoding]::UTF8.GetString($d),(New-Object Text.UTF8Encoding($true))); powershell -NoProfile -ExecutionPolicy Bypass -File $f; Read-Host '安裝結束，按 Enter 關閉'
```
