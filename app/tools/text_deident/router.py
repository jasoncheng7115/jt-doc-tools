...
def _detect_findings(text: str, selected_ids: set[str],
    ...
    # "台北市信義區忠孝東路五段123號" but RE_ROC_DATE inside also matches "123";
    # keep the longer one.
...
_FAKE_COMPANIES = [
    "大同股份有限公司", "群益顧問股份有限公司", "信義文創股份有限公司",
    "永豐企業股份有限公司", "中華資訊整合有限公司",
]
...
def _llm_extra_findings(full_text: str, already_known: list[str]) -> list[dict]:
    ...
    prompt = (
        ...
        "  - 訂單 / 採購 / 銷貨 / 報價單號（如「訂購單 12345」「採購案 2025-第三季-001」這類非 PO/SO 前綴格式）\n"
